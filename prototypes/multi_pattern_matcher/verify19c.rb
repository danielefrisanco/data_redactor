...
payloads = {
  ...
  # https:// edge cases — same corpus as v19b, to confirm the cheaper variant matches v15
  "https-slack"  => "post to https://hooks.slack.com/services/T01234567/B89ABCDEF/abcdefghijklmnopqrstuvwx now",
  "https-sentry" => "dsn=https://0123456789abcdef0123456789abcdef@o1.ingest.sentry.io/42 end",
  "https-eob"    => "see https://hooks.slack.com/services/T01234567/B89ABCDEF/abcdefghijklmnopqrstuvwx",
  "https-b2b"    => "https://hooks.slack.com/services/T01234567/B89ABCDEF/abcdefghijklmnopqrstuvwx https://o2.ingest.sentry.io/9 https://0a1b2c3d4e5f60718293a4b5c6d7e8f9@o2.ingest.sentry.io/9",
  "https-nomatch"=> "visit https://example.com/page and http://other.test for info",
  "https-dense"  => (["https://hooks.slack.com/services/T01234567/B89ABCDEF/abcdefghijklmnopqrstuvwx"] * 50).join(" "),
}
